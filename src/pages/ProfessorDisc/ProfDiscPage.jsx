...
export default function ProfDiscPage() {
  ...
  return (
    <div className="container-profdisc">
      ...
      <div className="filtros-profdisc">
        <label>
          Curso:
      ...
      <div className="form-associacao">
        ...
        <label>
          ...
          <input
            ...
            className="readonly-input-profdisc" 
        ...
        <button className="btn-associar" onClick={associar}>ASSOCIAR</button>
      </div>
      ...
      {showEditModal && editingAssociation && (
        <div className="modal-profdisc-overlay">
          <div className="modal-profdisc-content">
            <button className="modal-profdisc-close-btn" onClick={handleCloseEditModal}>
              &times;
            </button>
            <h3>Editar Alocação</h3>
            <div className="form-edit-associacao">
              <label>
                Disciplina:
                <select
              ...
              <label>
                ...
                <input
                  ...
                  readOnly
                  placeholder="Selecione uma disciplina"
                  className="readonly-input-profdisc-modal" 
